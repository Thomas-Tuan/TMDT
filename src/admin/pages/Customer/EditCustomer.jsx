...
const EditCustomer = () => {
        ...
        return (
            <Box textAlign="center">
                <Grid container spacing={1}>
                    <Grid item xs={12}>
                        {value ? (
                            <img value={value} className='userImg' src={value} alt='Existing' />
                        ) : (
                            <img className='userImg' src={ImagesBg.defaultBg} alt='Default' />
                        )}
                    </Grid>
                    <Grid item xs={12}>
                        <Button sx={{
    ...
    return (
        <Container disableGutters maxWidth="lg">
            ...
            <Box mt={2}>
                <Button variant="contained" color="primary" component={Link} to='/admin/customer'>
