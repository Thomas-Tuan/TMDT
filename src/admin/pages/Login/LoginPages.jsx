import { Box, Button, CircularProgress, FormControlLabel, FormGroup, Stack, TextField, Typography, circularProgressClasses, colors } from '@mui/material'
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Animate type="fade" delay={0.5}>
                            <img src={images.loginBg} alt="logo" height={60} />
                        </Animate>
                    </Box>
                    {/* Logo */}
                    {/* form */}
